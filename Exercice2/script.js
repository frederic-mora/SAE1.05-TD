...
/*  Q1
    ...
    Mais cette fois, on va utiliser une fenêtre pop-up pour permettre à l'utilisateur
    de saisir le texte de remplacement. Pour vous aider, vous pouvez regarder la doc et 
    notamment l'objet Window (https://developer.mozilla.org/fr/docs/Web/API/Window)
...
/*  Q2
    ...
    Puis, ajoutez ci-dessous l'instruction javascript permettant d'ajouter la classe css 'tollens' à divnode
    Renseignez-vous ici : https://developer.mozilla.org/fr/docs/Web/API/Element/classList
*/
// ??